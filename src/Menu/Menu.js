...
import logo from "../Menu/logoBlanc.png"

//Gestion du menus
var pages = ['Batteries', 'Scooter','Garantie', 'Nomenclatures'];
var settings = [ 'Logout'];
...
<AppBar position="static" sx={{bgcolor:"black"}}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <ElectricMopedIcon sx={{ display: { xs: 'none', md: 'flex',color: 'white' }, mr: 4 }} />
          <Typography
            variant="h8"
            noWrap
            component="a"
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none'} }}>
            ...
            <Menu
              ...
              sx={{
                display: { xs: 'block', md: 'none', backgroundColor:"white"
              }}}
            >
              {pages.map((page) => (
                <MenuItem key={page} 
